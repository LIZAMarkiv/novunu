...
k1.clicked.connect(pokaz_novun)
k2.clicked.connect(pokaz_novun)
k3.clicked.connect(pokaz_novun)
k4.clicked.connect(pokaz_novun)
k5.clicked.connect(pokaz_novun)
k6.clicked.connect(pokaz_novun)
